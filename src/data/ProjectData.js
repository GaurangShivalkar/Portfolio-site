const projectData = [
  {
    ...
    description:
      "Enterprise-grade onboarding platform integrating OCR and ID verification workflows.",
    techStack: [
      "Spring Boot",
      "REST APIs",
      "Spring Security",
  ...
  },
  {
    ...
    description:
      "Full-stack banking app featuring user authentication, transactions, and data dashboards.",
    techStack: [
      "Spring Boot",
      "React JS",
      "Tailwind CSS",
  ...
  },
  {
    ...
    description:
      "News aggregation platform with categorized APIs, dark mode, and commenting.",
  ...
  },
  {
    ...
    description:
      "Networking platform for job seekers, employers, and placement teams.",
