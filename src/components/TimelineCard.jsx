...
export const TimelineEducation = ({ item }) => (
    ...
    <div className='w-full h-full p-6 flex  flex-col justify-betwee'>
      ...
      <div className="flex flex-wrap gap-4 text-slate-400 mb-4" data-swiper-parallax="-80">
      ...
      <ul className="list-disc list-inside space-y-2 text-slate-300" data-swiper-parallax="-40">
...
export const TimelineCertification = ({ item }) => (
  
    <div className='w-full h-full p-6 flex flex-col justify-betwee'>
      <h3 className="text-2xl md:text-3xl font-extrabold text-white mb-1" data-swiper-parallax="-220">{item.name}</h3>
